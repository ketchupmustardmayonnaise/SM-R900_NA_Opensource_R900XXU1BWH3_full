...
#if (SENSOR_OS_VERSION < 13)
// R OS
#if defined(CONFIG_SENSORS_SSP_WISE)
#include "firmware/os_one_image_wise.h"
//#include "firmware/os_one_image_wise_rev00.h"
#define SSP_FIRMWARE_REVISION_CHUB   	23032900
//#define SSP_FIRMWARE_REVISION_CHUB_00   21020900
#elif defined(CONFIG_SENSORS_SSP_FRESH)
#include "firmware/os_one_image_fresh.h"
#define SSP_FIRMWARE_REVISION_CHUB   	23032900
#define SSP_FIRMWARE_REVISION_CHUB_DUAL_HRM    23032900
#elif defined(CONFIG_SENSORS_SSP_HEART)
#include "firmware/os_one_image_heart.h"
#define SSP_FIRMWARE_REVISION_CHUB   	23041400
#define SSP_FIRMWARE_REVISION_CHUB_DUAL_HRM    23041400
#else
#include "firmware/os_one_image.h"
//#define SSP_FIRMWARE_REVISION_CHUB   20121600
#error "need to define mode config !!!"
#endif //defined(CONFIG_SENSORS_SSP_WISE)
#else
// T OS
#if defined(CONFIG_SENSORS_SSP_WISE)
#include "firmware/os_one_image_wise_tos.h"
//#include "firmware/os_one_image_wise_rev00.h"
#define SSP_FIRMWARE_REVISION_CHUB   	23072400
//#define SSP_FIRMWARE_REVISION_CHUB_00   21020900
#elif defined(CONFIG_SENSORS_SSP_FRESH)
#include "firmware/os_one_image_fresh_tos.h"
#define SSP_FIRMWARE_REVISION_CHUB   	23072000
#define SSP_FIRMWARE_REVISION_CHUB_DUAL_HRM    23072000
#elif defined(CONFIG_SENSORS_SSP_HEART)
#include "firmware/os_one_image_heart.h"
#define SSP_FIRMWARE_REVISION_CHUB   	23072000
#define SSP_FIRMWARE_REVISION_CHUB_DUAL_HRM    23072000
