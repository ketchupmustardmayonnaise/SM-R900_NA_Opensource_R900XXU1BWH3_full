...
int exynos_profiler_set_queued_threshold_0(unsigned int threshold)
{
...
int exynos_profiler_set_queued_threshold_1(unsigned int threshold)
{
	CSTD_UNUSED(threshold);
	return 0;
}
...
void exynos_profiler_set_vsync(ktime_t timestamp)
{
...
void exynos_profiler_set_comb_ctrl(int enable)
{
	CSTD_UNUSED(enable);
}
