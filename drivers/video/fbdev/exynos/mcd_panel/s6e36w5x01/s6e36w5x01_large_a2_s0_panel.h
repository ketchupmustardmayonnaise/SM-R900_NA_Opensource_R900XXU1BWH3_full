...
static u8 LARGE_A2_S0_C31_FD_OFF[] = {
	0xEF,
	0x00
};
static DEFINE_STATIC_PACKET(large_a2_s0_c31_fd_off, DSI_PKT_TYPE_WR, LARGE_A2_S0_C31_FD_OFF, 0x1A);
...
static void *large_a2_s0_init_cmdtbl[] = {
	...
	&PKTINFO(large_a2_s0_c31_fd_off),
